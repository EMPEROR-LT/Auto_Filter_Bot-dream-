...
BOT_TOKEN = environ.get('BOT_TOKEN', "8198028348:AAEMJKcmIiTZVMcMapWVj0hDtfZdsX0o-Wk")    # Bot token from @BotFather
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002935398927').split()]  # Channel id for auto indexing (make sure bot is admin)
...
# ============================
QR_CODE = environ.get('QR_CODE', 'https://vault.pictures/p/4779dda236c345e19d8fdd66d40752f5')    # QR code image for payments
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ltarak570_db_user:F0I74fgOkSMeBmlm@cluster0.kdgqlpd.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database

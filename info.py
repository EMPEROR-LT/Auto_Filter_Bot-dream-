...
BOT_TOKEN = environ.get('BOT_TOKEN', "8278402505:AAFMFzN27SzLAPhyj1BoWCCb_kmKJI352Ew")    # Bot token from @BotFather
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003590714114').split()]  # Channel id for auto indexing (make sure bot is admin)
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002857234849')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+9J8z5nxAKG80MzJl')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("AUTH_REQ_CHANNELS", "-1002857234849")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
auth_channels     = environ.get("AUTH_CHANNELS", "-1002949178653")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ltarak570_db_user:zAIRPn92DgjoVZsl@cluster0.bmrg5lf.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+XCfPmMluP1w5MTQ9') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/G0D_EMPEROR_BOT') # Owner link for the bot
